...
var AngularFireCartAdmin = angular.module("AngularFireCartAdmin", [ "ngRoute", "firebase" ]).value("fbURL", "https://amhungry.firebaseio.com/");
...
AngularFireCartAdmin.directive("widget", function() {
    ...
    var firebasePath = fbURL + "/supermarketorders/";
    return firebasePath;
