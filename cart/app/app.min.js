...
var AngularFireCart = angular.module("AngularFireCart", [ "ngRoute", "ngAnimate", "cartModule", "firebase" ]).value("fbURL", "https://amhungry.firebaseio.com/");
    ...
    order.confirmationNumber || $location.path("/checkout"), $scope.placeOrder = function() {
        ...
        $scope.customers.$add($scope.customer).then(function(ref) {
            $scope.orders.$add({
                ...
                localStorage.orderkeysuper=ref.name();
...
angularCart.factory("cart", [ "$rootScope", "$filter", "localStorageService", function($rootScope, $filter, localStorageService) {
    ...
    var checkout = {}, firebaseOrdersURL = new Firebase(fbURL + "/supermarketorders"), firebaseCustomersURL = new Firebase(fbURL + "/customers");
